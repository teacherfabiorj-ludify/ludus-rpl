...
Rodar de dentro da pasta rpl_core_rulebook:
...
def flow_diagram():
    ...
    im.save("assets/flow_diagram.png")
...
def bands_chart():
    ...
    for col, txt in [(CRIT, "6 or under  —  Miss  (15/36)"),
        ...
        ly += 36
    im.save("assets/bands_chart.png")
...
def focus_cards():
    ...
    for i, (name, col, sub, body) in enumerate(cards):
        ...
        for ln in wrap(d, body, fr(17), cw - 52):
            ...
            yy += 26
    im.save("assets/focus_cards.png")
...
def sheet_annotated():
    ...
    im.crop((0, 0, 1660, 745)).save("assets/sheet_annotated.png")


if __name__ == "__main__":
    flow_diagram();    print("assets/flow_diagram.png")
    bands_chart();     print("assets/bands_chart.png")
    focus_cards();     print("assets/focus_cards.png")
    sheet_annotated(); print("assets/sheet_annotated.png")
